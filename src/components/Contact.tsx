...
export default function Contact() {
    return (
        <div className='p-10 flex bg-secondary-light w-full h-[250px] justify-center flex-wrap' >
            <div className='flex flex-1 min-w-full items-center justify-center gap-x-10'>
                <div className='flex-1 p-2 flex items-center justify-center max-w-[200px] hover:opacity-50'>
